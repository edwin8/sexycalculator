...
#import "APViewControllerParallel.h"

@interface APViewControllerParallel ()

@end

@implementation APViewControllerParallel
@synthesize stuff;
@synthesize stuff2;
@synthesize length;
@synthesize width;
